...
const SEARCH_INDEX: SearchItem[] = [
  ...
  { title: 'Pancakes (glutenfrei)',         desc: 'Frühstück · 25 Min · kleinkind · Eischnee-Trick', href: '/rezepte/dicke-pfannkuchen',           type: 'Rezept', tags: 'pancakes dicke pfannkuchen american fluffy eiweiß eischnee frühstück erdbeeren blaubeeren ahornsirup sonntagsfrühstück' },
  ...
  { title: 'Hot Dog Brötchen',             desc: 'Brot & Hefeteig · 3 Std. · Grill · einfrierbar',            href: '/rezepte/hotdog-broetchen',             type: 'Rezept', tags: 'hot dog brötchen brot hefeteig grill sommer einfrieren mohn flohsamenschalen reismehl' },
...
{ title: 'Italienische Focaccia',        desc: 'Brot & Hefeteig · 2 Std. · kein Kneten · Caputo',           href: '/rezepte/italienische-focaccia',        type: 'Rezept', tags: 'focaccia italienisch brot knoblauch knoblauchbutter parmesan caputo fioreglut hefeteig' },
  ...
  { title: 'Zöliakie & Genetik',          desc: 'Risiko für Geschwister, Gentests, HLA-DQ2/DQ8 erklärt',        href: '/wissen/zoeliakie-genetik',             type: 'Wissen', tags: 'genetik gen hla geschwister risiko erblich test bluttest familie' },
  ...
  { title: 'GdB bei Zöliakie',           desc: 'Versorgungsamt, Pauschbetrag 384€, ZBFS Bayern – ehrlicher Erfahrungsbericht', href: '/wissen/grad-der-behinderung-zoeliakiie', type: 'Wissen', tags: 'gdb grad behinderung versorgungsamt zbfs antrag pauschbetrag steuer widerspruch espghan biopsie' },
  { title: 'Pausenbrot & Snacks (Schule/Kita)', desc: 'Was kommt in die Brotdose? Ideen, Wochenplan, Fallen vermeiden', href: '/wissen/schule-kita/pausenbrot-snacks', type: 'Wissen', tags: 'pausenbrot snack brotdose schule kita brot aufschnitt muffin reiswaffel wochenplan kreuzverunreinigung' },
  { title: 'Klassenfahrt mit Zöliakie', desc: 'Unterkunft, Lehrer-Brief, Packliste, Notfallplan – damit die Fahrt klappt', href: '/wissen/schule-kita/klassenfahrt', type: 'Wissen', tags: 'klassenfahrt schulausflug jugendherberge unterkunft lehrer brief packliste notfall schule reise übernachtung' },
  { title: 'Vorlagen: Musterbrief & Checkliste', desc: 'Text kopieren oder als Word-Datei herunterladen – mit Platzhaltern', href: '/wissen/schule-kita/vorlagen', type: 'Wissen', tags: 'musterbrief brief vorlage checkliste kita schule erzieher lehrer knete pflegeartikel word download' },
